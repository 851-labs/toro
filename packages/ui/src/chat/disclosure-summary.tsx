...
export function CodexDisclosureSummary({
  ...
  return (
    <summary className="flex cursor-pointer list-none items-center gap-2 rounded-lg px-2 py-1.5 text-zinc-600 hover:bg-zinc-50/80 [&::-webkit-details-marker]:hidden">
